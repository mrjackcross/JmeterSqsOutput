...
public class SqsOutputGui extends AbstractListenerGui implements ClipboardOwner {

    public static final String WIKIPAGE = "SqsOutput";
    ...
    public String getStaticLabel() {
        return JMeterPluginsUtils.prefixLabel("Omnifone Sqs Output");
    }
    ...
    public void modifyTestElement(TestElement te) {
        ...
        if (te instanceof SqsOutput) {
            SqsOutput fw = (SqsOutput) te;
    ...
    public void configure(TestElement element) {
        ...
        SqsOutput fw = (SqsOutput) element;
    ...
    private class CopyAction
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            clipboard.setContents(transferable, SqsOutputGui.this);
        }
    }
}